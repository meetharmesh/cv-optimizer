...
[![Open in Streamlit](https://static.streamlit.io/badges/streamlit_badge_black_white.svg)] (place the link)

Live Demo

[Click here to try the Resume Optimizer](place the link)
...
```bash
git clone https://github.com/meetharmesh/cv-optimizer.git
cd resume-optimizer
````
...
Made by [@meetharmesh](https://github.com/meetharmesh/)
